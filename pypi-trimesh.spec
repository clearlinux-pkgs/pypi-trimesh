...
Version  : 3.18.3
Release  : 58
URL      : https://files.pythonhosted.org/packages/03/c6/8a4a7fc21a22ab1455782ad339ed2527a3252ae7f564267097d087944b1a/trimesh-3.18.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/03/c6/8a4a7fc21a22ab1455782ad339ed2527a3252ae7f564267097d087944b1a/trimesh-3.18.3.tar.gz
...
%prep
%setup -q -n trimesh-3.18.3
cd %{_builddir}/trimesh-3.18.3
pushd ..
cp -a trimesh-3.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675378604
