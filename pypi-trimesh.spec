...
Version  : 3.13.1
Release  : 31
URL      : https://files.pythonhosted.org/packages/c9/2c/b9d75b0a61cf2d4c3762949b525e8ad422451a0f17cf3febe3fd8dcc9b9b/trimesh-3.13.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/c9/2c/b9d75b0a61cf2d4c3762949b525e8ad422451a0f17cf3febe3fd8dcc9b9b/trimesh-3.13.1.tar.gz
...
%prep
%setup -q -n trimesh-3.13.1
cd %{_builddir}/trimesh-3.13.1
pushd ..
cp -a trimesh-3.13.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660167491
