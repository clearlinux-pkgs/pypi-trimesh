...
Source0  : https://files.pythonhosted.org/packages/38/9d/7cd8987c7df13ed4104ef103b732abc8e3bee5b4a3077e890d16322e9fdf/trimesh-4.4.3.tar.gz
...
%prep
%setup -q -n trimesh-4.4.3
cd %{_builddir}/trimesh-4.4.3
pushd ..
cp -a trimesh-4.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721244069
