...
Version  : 3.20.0
Release  : 61
URL      : https://files.pythonhosted.org/packages/cf/b9/1d6a6a0636ce1602fbd65bb3bcf85851542ccc32ebc646b7d0ba65da01b0/trimesh-3.20.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/cf/b9/1d6a6a0636ce1602fbd65bb3bcf85851542ccc32ebc646b7d0ba65da01b0/trimesh-3.20.0.tar.gz
...
%prep
%setup -q -n trimesh-3.20.0
cd %{_builddir}/trimesh-3.20.0
pushd ..
cp -a trimesh-3.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676419268
