...
Version  : 3.15.3
Release  : 41
URL      : https://files.pythonhosted.org/packages/f1/8a/17cb076d8ccae5840ae7e5ee5e15f4188897acae325eb9f714c0a2e4e9f2/trimesh-3.15.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/f1/8a/17cb076d8ccae5840ae7e5ee5e15f4188897acae325eb9f714c0a2e4e9f2/trimesh-3.15.3.tar.gz
...
%prep
%setup -q -n trimesh-3.15.3
cd %{_builddir}/trimesh-3.15.3
pushd ..
cp -a trimesh-3.15.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664830899
