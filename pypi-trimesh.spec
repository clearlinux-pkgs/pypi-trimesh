...
Source0  : https://files.pythonhosted.org/packages/9d/b3/0b5ba2a4512f236bdde54410fa11f0b8a37663729057c084308691ebf963/trimesh-3.13.5.tar.gz
...
%prep
%setup -q -n trimesh-3.13.5
cd %{_builddir}/trimesh-3.13.5
pushd ..
cp -a trimesh-3.13.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660780877
