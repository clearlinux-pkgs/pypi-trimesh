...
Version  : 3.16.1
Release  : 49
URL      : https://files.pythonhosted.org/packages/dc/40/9beb5772cd121a1a0639a3d460284b246b170ad39367319de57d8ad3829b/trimesh-3.16.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/dc/40/9beb5772cd121a1a0639a3d460284b246b170ad39367319de57d8ad3829b/trimesh-3.16.1.tar.gz
...
%prep
%setup -q -n trimesh-3.16.1
cd %{_builddir}/trimesh-3.16.1
pushd ..
cp -a trimesh-3.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668097360
