...
Version  : 3.14.1
Release  : 37
URL      : https://files.pythonhosted.org/packages/98/1a/b022c3589554f4afd8d8bf0706d0236ce2ab6cc6b9719d9148f0292356fd/trimesh-3.14.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/98/1a/b022c3589554f4afd8d8bf0706d0236ce2ab6cc6b9719d9148f0292356fd/trimesh-3.14.1.tar.gz
...
%prep
%setup -q -n trimesh-3.14.1
cd %{_builddir}/trimesh-3.14.1
pushd ..
cp -a trimesh-3.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662312316
