...
Version  : 3.19.4
Release  : 60
URL      : https://files.pythonhosted.org/packages/e1/2a/a18d8d8b7cd8cfe5249b0f73f2382481c9dad2c319740104749640e3f759/trimesh-3.19.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/e1/2a/a18d8d8b7cd8cfe5249b0f73f2382481c9dad2c319740104749640e3f759/trimesh-3.19.4.tar.gz
...
%prep
%setup -q -n trimesh-3.19.4
cd %{_builddir}/trimesh-3.19.4
pushd ..
cp -a trimesh-3.19.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676252089
