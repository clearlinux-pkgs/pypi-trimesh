...
Version  : 3.15.4
Release  : 42
URL      : https://files.pythonhosted.org/packages/d3/a9/eb23062da1de8b966f9224cf7af3da4b543e86523630f79a048fb617a9f5/trimesh-3.15.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/d3/a9/eb23062da1de8b966f9224cf7af3da4b543e86523630f79a048fb617a9f5/trimesh-3.15.4.tar.gz
...
%prep
%setup -q -n trimesh-3.15.4
cd %{_builddir}/trimesh-3.15.4
pushd ..
cp -a trimesh-3.15.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665601788
