...
Version  : 3.12.8
Release  : 19
URL      : https://files.pythonhosted.org/packages/00/93/9a44faca1bb079b26d4cca819bd51b203406e209a625dd1860446f3cade3/trimesh-3.12.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/00/93/9a44faca1bb079b26d4cca819bd51b203406e209a625dd1860446f3cade3/trimesh-3.12.8.tar.gz
...
%prep
%setup -q -n trimesh-3.12.8
cd %{_builddir}/trimesh-3.12.8
pushd ..
cp -a trimesh-3.12.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657759325
...
cp %{_builddir}/trimesh-3.12.8/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-trimesh/4340a750e3e91283c3d07c3eebda208f9e666c0b
