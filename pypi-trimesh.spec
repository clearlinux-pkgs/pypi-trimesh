...
Source0  : https://files.pythonhosted.org/packages/69/16/528abbbaf9e47a429b92ad3478ede14f6c2879bf6b742a97b8dd2fee923d/trimesh-3.14.0.tar.gz
...
%prep
%setup -q -n trimesh-3.14.0
cd %{_builddir}/trimesh-3.14.0
pushd ..
cp -a trimesh-3.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661276177
